...
// Define directories.
var buildDir = "./src/CloudFront/bin/" + configuration;
var buildTestDir = "./src/CloudFront.Tests/bin/" + configuration;
...
// Package
var zipPackage = buildResultDir + "/Cake-AWS-CloudFront-v" + semVersion + ".zip";
...
Task("Copy-Files")
    ...
    .Does(() =>
{
    CopyFileToDirectory(buildDir + "/Cake.AWS.CloudFront.dll", binDir);
...
Task("Create-NuGet-Packages")
    ...
    .Does(() =>
{
    NuGetPack("./nuspec/Cake.AWS.CloudFront.nuspec", new NuGetPackSettings 
    {
        Version = version,
    ...
    .Does(() =>
{
    ...
    // Push the package.
    var package = nugetRoot + "/Cake.AWS.CloudFront." + version + ".nupkg";
